...
public class GetPostDataFromServer {
    private static PerformBackgroundtask mtask;
    public ProgressDialog dialog;
    String data;
    private Activity mActivity;
    private String response_data, response_data_line;
    ...
    public String getResponse(String url, String data, String api_name, boolean showLoader) {
        try {
